...
from .unet import unet_res50
from .upsampling_layer import DoubleConv, Up

vgg_layers = {'pool4': 24, 'pool5': 31}
net_stride = {'vgg_pool4': 16, 'vgg_pool5': 32, 'resnet50': 32, 'resnext50': 32, 'resnetext': 8, 'resnetupsample': 8, 'resnetext2': 4, 'resnetext3': 4, 'unet_res50': 1}
net_out_dimension = {'vgg_pool4': 512, 'vgg_pool5': 512, 'resnet50': 2048, 'resnext50': 2048, 'resnetext': 256, 'resnetupsample': 2048, 'resnetext2': 256, 'resnetext3': 256, 'unet_res50': 64}
...
class ResNetExt2(nn.Module):
    def __init__(self, pretrained):
        super(ResNetExt2, self).__init__()
        net = models.resnet50(pretrained=pretrained)
        self.extractor = nn.Sequential()
        self.extractor.add_module('0', net.conv1)
        self.extractor.add_module('1', net.bn1)
...
class ResNetExt3(nn.Module):
    def __init__(self, pretrained):
        super(ResNetExt3, self).__init__()
        net = models.resnet50(pretrained=pretrained)
        self.extractor = nn.Sequential()
        self.extractor.add_module('0', net.conv1)
        self.extractor.add_module('1', net.bn1)
